...
<body style="margin:0;padding:0;background:#f9fafb;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
  <div style="max-width:520px;margin:0 auto;padding:40px 20px;">
    ...
    <p style="font-size:15px;color:#374151;line-height:1.7;margin:0 0 16px;">
      Queremos acompañarte en este momento tan especial. Por eso creamos un portal exclusivo para vos, donde podés:
    </p>

    <div style="background:#f3f4f6;border-radius:12px;padding:20px;margin-bottom:24px;">
      <p style="margin:0 0 10px;font-size:14px;color:#374151;">🐾 &nbsp;<strong>Seguir el estado</strong> del servicio en tiempo real</p>
      <p style="margin:0 0 10px;font-size:14px;color:#374151;">📸 &nbsp;<strong>Subir fotos</strong> de tu mascota para el memorial</p>
      <p style="margin:0 0 10px;font-size:14px;color:#374151;">💬 &nbsp;<strong>Escribir una dedicatoria</strong> en su memoria</p>
      <p style="margin:0;font-size:14px;color:#374151;">🔗 &nbsp;<strong>Compartir el memorial</strong> con familia y amigos</p>
    </div>

    <div style="text-align:center;margin-bottom:32px;">
      <a href="${linkActivacion}" style="display:inline-block;background:#111827;color:white;padding:14px 32px;border-radius:12px;font-size:15px;font-weight:600;text-decoration:none;">
        Activar mi portal →
      </a>
    </div>
