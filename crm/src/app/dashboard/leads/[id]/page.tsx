        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{ background: 'white', borderRadius: 16, border: '1px solid #f3f4f6', padding: '24px', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              {lead.mensaje && (
                <div style={{ paddingTop: 10, borderTop: '1px solid #f3f4f6', marginTop: 4 }}>
                  <p style={{ fontSize: 12, color: '#9ca3af', margin: '0 0 4px' }}>Mensaje inicial</p>
          ...
          <div style={{ background: 'white', borderRadius: 16, border: '1px solid #f3f4f6', padding: '24px', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              ...
              <InfoRow
                ...
                value={agente?.nombre ?? 'Sin asignar'}
              />
              <InfoRow
                label="Primera respuesta"
                value={tiempoRespuesta ? `En ${tiempoRespuesta}` : 'Sin respuesta aún'}
              />
              <InfoRow
                label="Interacciones"
