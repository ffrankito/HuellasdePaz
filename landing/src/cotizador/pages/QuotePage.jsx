...
const CRM_BASE_URL = import.meta.env.PUBLIC_CRM_URL || "https://huellasde-paz.vercel.app";
...
const CRM_API_URL = import.meta.env.PUBLIC_CRM_API_URL || "https://huellasde-paz.vercel.app/api/leads";
...
const renderStep3 = () => (
  ...
  const renderSuccess = () => {
    ...
    const waUrl = "https://wa.me/5493417523248?text=" + waText;
    return (
